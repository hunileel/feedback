...
<body>
	...
	<article>
		<section>
            ...
            <ul>
                ...
                <c:forEach items="${requestScope.listProtype}" var="words">
                    <!-- 如果留言信息是在本文章下的才显示 -->
                        <li >
	...
	<footer><div class="m-btn-wrapper">
			<button class="active" style="border:1px solid #CCC;"  onclick="window.location.href = 'https://www.baidu.com/'">所有问题</button>
			<button style="border:1px solid #CCC;" onclick="window.location.href = 'toReply'">问题反馈</button>
		</div>
		</footer>
		</div>
</body>
