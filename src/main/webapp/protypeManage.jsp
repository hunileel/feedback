...
<div class="container" style="width: 90%;">
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover" id="countTable">
            <thead>
            <tr>
                <th style="text-align: center">一级问题</th>
                <th style="text-align: center">大类内容</th>
            ...
            <c:forEach items="${requestScope.page.beanList}" var="article">
                <tr>
                    <td>${article.n_id}</td>
                    <td>${article.n_name}</td>
                    <c:if test="${sessionScope.identity_id ne 4}">
                        <td>
                        <a href="<%=basePath%>/protype/toArticleView.do?fb_id=${article.n_id}"><button type="button" class="layui-btn layui-btn-sm">查看</button>
                            <button type="button" onclick="return clean(${article.n_id});" class="layui-btn layui-btn-sm layui-btn-danger">删除</button>
                        </td>
                    </c:if>
                </tr>
            </c:forEach>
...
<div class="price" data-goodsid='12' data-itemid='3' data-oldvalue='3'>123</div>
</body>
