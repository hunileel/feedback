            ...
            <div>
                <div class="layui-form-item layui-inline" style="width:110%">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="device" class="layui-input" style="background:none;border: none;border-bottom:1px solid white;" placeholder="Username"/>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="password" name="mac" class="layui-input" style="background:none;border: none;border-bottom:1px solid white;" placeholder="Password"/>
                    </div>
                </div>
                <br/>
                <br/>
        ...
        <form action="<%=basePath%>/admin/register.do" id="registerform" method="post" class="layui-form" hidden="hidden" style="text-align: center;margin-right:12%;margin-top:10%;">
            <div>
                <div class="layui-form-item layui-inline" style="width:110%">
                    <label class="layui-form-label" style="margin-left:13%;"><i class="fa fa-user fa-fw"></i></label>
                    <div class="layui-input-inline">
                        <input type="text" name="deivce" id="device" onblur="return checkName();" class="layui-input" style="background:none;border: none;border-bottom:1px solid white;" placeholder="Username"/>
                    </div>
                    <span id="info"></span>
                </div>
                <br/>
