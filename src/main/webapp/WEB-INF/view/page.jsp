...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo" style="font-size: 17px;"><strong>帮助与反馈管理系统</strong></div>
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    ...
                    <hr/>
                    <dd><a href="<%=basePath%>/user/outLogin.do" style="text-decoration: none;;"><strong>退出登录</strong></a></dd>
                </dl>
            </li>
            <li class="layui-nav-item">
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item">
                    <a style="text-decoration: none;"><strong><span class="fa fa-leaf fa-fw"></span>&nbsp;&nbsp;&nbsp;反馈回复</strong></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" onclick="javascript: toArticleManage();" style="text-decoration: none;"><strong>反馈列表</strong></a></dd>
                        <dd><a href="javascript:;" onclick="javascript: toArticleWrite();" style="text-decoration: none;"><strong>问题列表</strong></a></dd>
    ...
    <div class="layui-body">
        <div id="content">
            <div style="font-size: 45px;color: #1D9D73;margin-top: 300px;" class="text-center"><strong>欢迎反馈回复管理系统</strong></div>
            <p class="text-center">
                <strong style="color: #1D9D73;">本系统由南晧智能科技部实现功能以及页面的美化</strong>
            </p>
        </div>
    </div>
...
<script type="text/javascript">
    function toArticleWrite() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"<%=basePath%>/protype/findByPage.do\" width=\"100%\" height=\"100%\"></object>";
    }
    function toArticleManage() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"<%=basePath%>/feedback/findByPage.do\" width=\"100%\" height=\"100%\"></object>";
    }
    function toArticleTrash() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"<%=basePath%>/article/findByPage.do\" width=\"100%\" height=\"100%\"></object>";
    }
</script>
</html>