...
<br/>
    ...
    <br/>
				...
				<form  action="/feedback/protype/save" method="post" >
				    <input name="nId" value="${nId}" hidden="hidden"/>
					<textarea class="form-control" rows="4"
						style="border: 1px; resize: none; width: 100%; background-color: #eee"
						name="scName" placeholder="请输入标题"></textarea>
					<textarea class="form-control" rows="4"
						style="border: 1px; resize: none; width: 100%; background-color: #eee"
						name="scDetaila" placeholder="请输入内容a"></textarea>
					<textarea class="form-control" rows="4"
						style="border: 1px; resize: none; width: 100%; background-color: #eee"
						name="scDetailb" placeholder="请输入内容b"></textarea>
					<textarea class="form-control" rows="4"
						style="border: 1px; resize: none; width: 100%; background-color: #eee"
						name="scDetailc" placeholder="请输入内容c"></textarea>
							...
							<div id="sendButtom" style="flex: auto;">
								...
								<div id="two" style="float: left;">
									<button id="postWeibo" type="submit"
										class="form-control btn btn-success">确定</button>
								</div>
							</div>
						</div>
					</div>
