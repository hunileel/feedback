...
<body>
	...
	<article>
		<section class="m-btn-wrapper">
			<button class="active btn-l" onclick="window.location.href = 'toText'">意见反馈</button>
			<button class="btn-r" disabled="disabled">客服回复</button>
		</section>
		<section>
			<!-- 留言信息列表展示 -->
            <ul>
                ...
                <c:forEach items="${requestScope.listWords}" var="words">
                    <!-- 如果留言信息是在本文章下的才显示 -->
                        <li >
                                 <a href="toRewordView?fb_id=${words.fb_id}" style="text-decoration: none;" onclick="btnRewordClick(this)">
                               ${words.fb_content}</a>
                        </li>
