	...
	<article>
		<section>
            ...
            <ul>
                ...
                <c:forEach items="${requestScope.allpro}" var="words">
                    <!-- 如果留言信息是在本文章下的才显示 -->
                        <li >
                                 <a href="toSecpro?nId=${words.nId}" style="text-decoration: none;" onclick="btnRewordClick(this)">
                               ${words.nName}</a>
                        </li>
