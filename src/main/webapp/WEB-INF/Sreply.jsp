...
<body>
    ...
    <form  name="myform" action="/feedback/article/saveWord" method="post" class="form-report">
       
        <label>
             <div class="cube-upload-btn">
             	<div class="cube-upload-btn-def" >
             		<i><input type="file" class="cube-upload-input" multiple="multiple" accept="image/*" /></i>
             	</div>
             </div>
            <textarea id="fb_content" name="fb_content" placeholder="Your can tell me" ></textarea>
